...
const ArticleForm: React.FC = () => {
  ...
  const handleTitleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setTimeout(() => setSlugAutoGenerated(false), 2000);
  };
  ...
  const handleTagInput = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (!availableTags.includes(tags[tags.length - 1])) {
      setAvailableTags((prev) => [...prev, tags[tags.length - 1]]);
    }
  };
      ...
      {isPreview ? (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
          ...
          <div className="preview-content">
            ...
            {imagePreview && (
              <div className="mb-6">
                <img src={imagePreview} alt={formData.imageAltText} className="w-full h-auto rounded-lg" />
              </div>
            )}
        ...
        >
          ...
          <div className="mb-4 relative">
            ...
            />
            {slugAutoGenerated && (
              <span className="absolute right-2 top-10 text-sm text-green-500 animate-pulse">
                Auto-generated
              </span>
            )}
          </div>
